...
export function Sidebar({ className }: SidebarProps) {
  ...
  if (!isOpen) {
    return (
      <aside
        className={`fixed left-0 top-0 z-40 flex h-full w-16 flex-col items-center border-r border-gray-700 bg-[#040404] py-4 ${
          className ?? ""
        }`}
      >
        {/* Open Button */}
  ...
  return (
    <aside
      className={`fixed left-0 top-0 z-40 flex h-full w-64 flex-col border-r border-gray-700 bg-[#040404] ${
        className ?? ""
      }`}
    >
